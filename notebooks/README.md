...
| Multilingual extra (**beyond-paper**): why the operation swap never lands — a strength arm (→30×) + the frozen-vs-live-attention QK probe | `multilingual_extra_operation_swap.ipynb` | `multilingual_helper.py` |

...
Figure~\ref{fig:feature-example} shows one reviewed member of the
\emph{small (multilingual)} group in the re-implemented feature viewer.
...
\caption{An example of the feature, using the re-implemented feature viewer.}
...
\subsection{Reproduction summary}\label{sec:exp:verdicts}

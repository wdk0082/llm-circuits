...
Figure~\ref{fig:feature-example} shows the evidence this selection matches against,
for one reviewed member of the \emph{small (multilingual)} group.
Figure~\ref{fig:ml-graphs} shows the resulting simplified graphs
...
counterpart of Figure~\ref{fig:ml-graphs} and interactive-explorer views of the
English page in each format are in Appendix~\ref{app:snapshots}.

\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/explorer_feature_example.png}
\caption{The evidence a supernode selection matches against, for one reviewed member
of the \emph{small (multilingual)} group: top/bottom output logits, the feature's
activation distribution on the prompt token, and top-activating dataset examples
(activating token highlighted).}
\label{fig:feature-example}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/explorer_chat_antonym_en.png}
\caption{Explorer view of the chat antonym page (en) with the reviewed supernodes
as groups.}
\label{fig:app-chat}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/explorer_raw_antonym_en.png}
\caption{Explorer view of the raw open-quote antonym page (en; the paper's format).}
\label{fig:app-raw}
\end{figure}
